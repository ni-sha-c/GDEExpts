...
def plot_multi_step_traj_3D(dyn_sys, optim_n, test_t, pred_traj, true_traj):
    ...
    figure(figsize=(18, 6))
    title("Multi-Step Predicted Trajectory of Lorenz")
...
LE_node = lyap_exps("lorenz", [lorenz, 3], true_traj = multi_step_traj, iters=5*(10**4), time_step= 1e-2, optim_name="AdamW", method="NODE")
print(LE_node)
